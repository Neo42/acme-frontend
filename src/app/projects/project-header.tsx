...
const ProjectHeader = ({ activeTab, setActiveTab }: Props) => {
  ...
  return (
    <div className="px-4 xl:px-6">
      <h1 className="pb-6 pt-6 lg:pb-4 lg:pt-8">
...
const TabButton = ({
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex items-center gap-2 rounded-md px-1 py-2 text-gray-500 after:absolute after:-bottom-[9px] after:left-0 after:h-[1px] after:w-full hover:text-blue-600 dark:text-neutral-500 dark:hover:text-white sm:px-2 lg:px-4",
